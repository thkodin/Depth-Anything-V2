...
from dataset.knotty_captcha import KnottyCaptcha
...
parser.add_argument("--dataset", default="hypersim", choices=["hypersim", "vkitti", "knotty_captcha"])
...
def main():
    ...
    is_distributed = torch.cuda.device_count() > 1 and args.ngpus > 1
    if is_distributed:
    ...
    valloader = DataLoader(
        valset, batch_size=1, pin_memory=True, num_workers=4, drop_last=True, sampler=valsampler, shuffle=False
    )
